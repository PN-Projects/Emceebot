...
from EmceeBot.modules.log_channel import gloggable, loggable
...
def kickme(update: Update, context: CallbackContext):
    ...
    if res:
        update.effective_message.reply_text("*just get out you idiot*")
    else:
...
*Admins only:*
 ...
 ❍ /kick <userhandle>*:* kicks the user out of the group, (via handle, or reply)
"""
