...
import EmceeBot.modules.fun_strings as fun_strings
from EmceeBot import dispatcher
...
PHOTO = 'https://telegra.ph/file/d11559c784754933b69c2.jpg'
...
def sanitize(update: Update, context: CallbackContext):
    ...
    reply_animation(GIF_ID, caption=f'*Sanitizes {user}*')
...
def awake(update: Update, context: CallbackContext):
    ...
    reply_photo(
        random.choice(fun_strings.EMCEE_IMG), caption=f'*READY TO SERVE YOU {name}*')    
...
AWAKE_HANDLER = DisableAbleCommandHandler("awake", awake)      
...
__handlers__ = [
    RUNS_HANDLER, SLAP_HANDLER, AWAKE_HANDLER, PAT_HANDLER, ROLL_HANDLER, TOSS_HANDLER,
