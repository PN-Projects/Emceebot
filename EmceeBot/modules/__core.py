...
from EmceeBot import TEMP_DOWNLOAD_DIRECTORY as path
from EmceeBot import TEMP_DOWNLOAD_DIRECTORY
from datetime import datetime
water = './EmceeBot/resources/IMG_20210502_211803_187.jpg'
client = tbot
...
async def Prof(event):
    ...
    the_plugin_file = "./EmceeBot/modules/{}.py".format(input_str)
...
# from EmceeBot.events import load_module
# import asyncio
# import os
# from datetime import datetime
...
#                     "EmceeBot/modules/",  # pylint:disable=E0602
#                 )
#             )
...
from EmceeBot import telethn as tbot, OWNER_ID, DEV_USERS
from EmceeBot.events import register
import os
import asyncio
import os
...
from pathlib import Path
from EmceeBot import telethn as borg
