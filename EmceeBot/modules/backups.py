...
import EmceeBot.modules.sql.notes_sql as sql
from EmceeBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from EmceeBot.__main__ import DATA_IMPORT
from EmceeBot.modules.helper_funcs.chat_status import user_admin
from EmceeBot.modules.helper_funcs.alternate import typing_action

# from EmceeBot.modules.rules import get_rules
import EmceeBot.modules.sql.rules_sql as rulessql

# from EmceeBot.modules.sql import warns_sql as warnssql
import EmceeBot.modules.sql.blacklist_sql as blacklistsql
from EmceeBot.modules.sql import disable_sql as disabledsql

# from EmceeBot.modules.sql import cust_filters_sql as filtersql
# import EmceeBot.modules.sql.welcome_sql as welcsql
import EmceeBot.modules.sql.locks_sql as locksql
from EmceeBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("EmceeBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("EmceeBot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Emcee-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("EmceeBot{}.backup".format(chat_id))  # Cleaning file
...
*Only for group owner:*
 ...
 ❍ /import: Reply to the backup file for the butler / emcee group to import as much as possible, making transfers very easy! \
